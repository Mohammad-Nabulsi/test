...
def generate_recommendations(
    ...
    for _, r in biz.iterrows():
        ...
        if followers >= 12000 and er < 0.010:
            add(
                bname,
                sector,
        ...
        if reels_better and reels < 0.32:
            add(
                bname,
                sector,
        ...
        if dialect_better and dialect < 0.42:
            add(
                bname,
                sector,
