...
const items = [
  ...
  { to: "/similar-business-recommendations-single", label: "Similar Business API", icon: Users },
  { to: "/benchmark-dashboard-single", label: "Benchmark API", icon: Target },
  { to: "/next-post-recommendations-single", label: "Next Post API", icon: BadgePercent },
